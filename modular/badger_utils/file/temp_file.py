...
class TempDirectory(tempfile.TemporaryDirectory):
    """Creates a temporary directory context, deletes the dir after exiting the context.
    Unlike tempfile.TemporaryDirectory a Path is returned
    returns the Path
    """
